...
//		s = Replace(s, " ", "&nbsp;");
	...
	*/
	...
	public static String textReplaceStars(String text,int start,int end){
		if(text==null){
			return "";
		}
		String newText = "";
		for (int i = 0; i < text.length(); i++) {
			if(i >= start && i < text.length()-end){
				newText += "*";
			}else{
	...
	public static String getRatStrin(String text){
...
//				rat +="*";
	...
	public static String getRatStr1(String text){
		if(TextUtils.isEmpty(text))
			return "";
		String rat = "";
		for (int i = 0; i < text.length(); i++) {
	 ...
	 * @return
	 */
	public static String getRatStr2(String text){
		if(TextUtils.isEmpty(text))
			return "";
		StringBuffer rat = new StringBuffer();
		for (int i = 0; i < text.length(); i++) {
			if(i>=3 && i<=6){
				rat.append("*");
			}else{
				rat.append(text.charAt(i));
			}
		}
		
		return rat.toString();
	}
	public static String getRatStr(String text){
		if(TextUtils.isEmpty(text))
			return "";
		StringBuffer rat = new StringBuffer();
		for (int i = 0; i < text.length(); i++) {
	...
	//切割姓名
	public static String getRatStr3(String text){
		if(TextUtils.isEmpty(text))
			return "";
		StringBuffer rat = new StringBuffer();
		for (int i = 0; i < text.length(); i++) {
	 ...
	 * @return
	 */
	public static String getRatStr4(String text){
		if(TextUtils.isEmpty(text))
			return "";
		int a = text.length();
		StringBuffer rat = new StringBuffer();
